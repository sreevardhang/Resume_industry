...
\end{itemize}
%\textbf{Bharat Dynamics Limited}, Hyderabad, India \hfill \raggedright{Feb 2016 - Jul 2016}\\
%\textbf{Industrial Trainee}, \textit{Milan - CP Division}
%\begin{itemize}%[leftmargin=*]
%\setlength\itemsep{-2pt}
%\vspace{-5pt}
%\item Assisted the General manager in the production of the \textit{Long shell} component of Milan 2T missile by creating a 3D model of the Long Shell component of the Milan 2T missile using AutoCAD.
%\item Prepared an improved CNC part program and implemented the cutting path to manufacture a prototype of the component. Submitted a full technical report to external jury.
%\end{itemize}
\vspace{-8pt}
\noindent \rule[2pt]{\textwidth}{0.5pt}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% \item Kulkarni, V., \textbf{Tamvada, S.}, Shirdade, N., Saneie, N., Lolla, V.Y., Batheyrameshbapu, V. and Anand, S., ``Rebound of partially solidified drops", \textit{arXiv preprint arXiv:2208.03801}, 2022.
% \item Kulkarni, V., Lolla, V.Y., \textbf{Tamvada, S.} and Anand, S., ``Bursting Drops", \textit{arXiv preprint arXiv:2204.04804}, 2022.
...
% \noindent \rule[2pt]{\textwidth}{0.5pt}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\noindent \textbf{\large \textcolor{Brown}{Affiliations}}\vspace{2pt}\\
%\begin{itemize}
%\setlength\itemsep{0pt}
%\vspace{-8pt}
%\item Collegiate member, American Institute of Aeronautics and Astronautics \hfill \raggedright{{Sep 2017 - Present}}
%\item Member, Pi Tau Sigma UIC chapter\hfill \raggedright{{May 2018 - Present}}
%\item Student member, The Adhesion Society \hfill \raggedright{{Feb 2019 - Present}}
%\item Student member, American Physical Society \hfill \raggedright{{May 2019 - Present}}
%\end{itemize}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
